...
```bash
git clone https://github.com/valdery55/dio-lab-open-source.git
```
Pressione enter, e uma cópia do seu fork no GitHub será criada localmente.

### 3) Crie uma nova **branch** 
Utilize o comando `git checkout -b` para criar e alternar para a nova branch e nomeie-a como `feat/community/valdery55`
> Exemplo: `git checkout -b feat/community/valdery55`
...
Envie as alterações realizadas no seu repositório local para a branch `feat/community/valdery55` no seu repositório remoto com o comando:
```bash
git push origin feat/community/valdery55
```
>[!WARNING]
